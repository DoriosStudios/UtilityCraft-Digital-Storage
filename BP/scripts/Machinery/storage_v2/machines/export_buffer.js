  ...
  onPlace({ block }) {
    system.run(() => {
      const entity = spawnEntity(block, {
        entity: {
          identifier: EXPORT_BUFFER_ENTITY_TYPE,
          inventory_size: INVENTORY_SIZE,
          input_range: [FILTER_START_SLOT, FILTER_END_SLOT],
          output_range: [OUTPUT_START_SLOT, OUTPUT_END_SLOT],
          name: "export_buffer",
        },
      });
